    ...
    switch (result) {
      ...
      case Failure(:final exception):
        final message = exception.code == 'card_in_use'
            ? 'Bu karta faol bron uchun band — bron tugagach o\'chirish mumkin'
            : exception.message;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Karta raqami hech qachon saqlanmaydi. Bosib ushlab turing — o\'chirish.',
                      style: GoogleFonts.plusJakartaSans(
                        fontSize: 12.sp,
                        fontWeight: FontWeight.w400,
                        color: const Color(0xFF9CA3AF),
