...
| Nima | Holat |
|---|---|
| Depozit, karta bloklash | ✅ `03-depozit.md` |
| Navbatga yozilish | ✅ `05-navbat.md` |
| Sharh yozish | Yo'q |
| Bildirishnomalar (eslatma, stol bo'shadi) | Yozuv saqlanadi; push manzili tayyor (`POST /me/devices`), provayder `mock` |
| Muassasa kartochkasi, menyu | ✅ `04-katalog.md` |
